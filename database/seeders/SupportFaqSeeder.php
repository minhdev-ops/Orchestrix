...
class SupportFaqSeeder extends Seeder
{
    public function run(): void
    {
        SupportFaq::insert([
            ...
            ['question' => 'Thời gian giao hàng trung bình là bao lâu?', 'answer' => 'Giao hàng nội thành trong 2-3 ngày làm việc, ngoại thành 5-7 ngày làm việc. Chúng tôi sử dụng dịch vụ GHTK để đảm bảo chất lượng.', 'category' => 'Vận chuyển', 'sort_order' => 5, 'created_at' => now(), 'updated_at' => now()],
