  ...
  <div class="login-page">
    <div class="login-container">
      <div class="login-card">
        ...
        <p class="login-subtitle">Tạo tài khoản AgriVerse mới</p>
        ...
        <form @submit.prevent="handleRegister" class="login-form">
          ...
          <div>
            <label class="login-label">Họ tên</label>
        ...
        <div class="login-social">
          <button @click="registerWithGoogle" :disabled="socialLoading" class="login-social-btn">
          ...
          <button @click="registerWithFacebook" :disabled="socialLoading" class="login-social-btn login-social-fb">
        ...
        <div class="login-divider">
          ...
          <Link :href="route('login')" class="login-register-link">Đăng nhập</Link>
        </div>
      </div>
    </div>
  </div>
...
.login-success {
  padding: 12px 16px;
  border-radius: var(--ag-radius-lg);
  background: color-mix(in srgb, var(--ag-success) 8%, transparent);
