            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;">
                ...
                <tr>
                    <td style="padding:40px;">
                        ...
                        <p style="color:#666;line-height:1.6;">Cảm ơn bạn đã đăng ký tài khoản tại AgriVerse. Vui lòng nhấn nút bên dưới để kích hoạt tài khoản:</p>
                        <div style="text-align:center;margin:30px 0;">
                            <a href="{{ route('active.mail', ['email' => $email, 'key' => $hash]) }}"
                        ...
                        <p style="color:#999;font-size:12px;line-height:1.6;">Nếu bạn không đăng ký tài khoản, vui lòng bỏ qua email này. Link sẽ hết hạn sau 24 giờ.</p>
                    </td>
                </tr>
                <tr>
